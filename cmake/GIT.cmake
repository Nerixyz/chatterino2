...
if(GIT_EXECUTABLE)
    ...
    if(GIT_REPOSITORY_FOUND)
        ...
        # Last commit from upstream in our current branch
        run_git(_git_merge_base merge-base HEAD upstream/master)
        if(_git_merge_base_result EQUAL 0)
            # Commits from upstream that are in our branch as well since the tag
...
if (_c2_git_print_version)
    set(_version_msg "${GIT_RELEASE}-${GIT_NIGHTLY_COMMITS}")
