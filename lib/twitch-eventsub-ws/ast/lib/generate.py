...
def _generate_definition(items: list[Struct | Enum]) -> str:
    current_ns = ""
    doc = """// WARNING: This file is automatically generated. Any changes will be lost.
...
"""
    ...
    for item in items:
        ...
        if next_ns != current_ns:
            ...
            current_ns = next_ns
        doc += item.try_value_to_definition(env) + "\n\n"
...
def generate(header_path: str, additional_includes: list[str] = []) -> Tuple[str, str]:
    ...
    definitions = format_code(_generate_definition(structs))
