    ...
    const std::string &key)
{
    ...
    auto accountType = static_cast<TwitchAccount::Type>(
        pajlada::Settings::Setting<
            std::underlying_type_t<TwitchAccount::Type>>::get("/accounts/" +
                                                              key +
                                                              "/accountType"));
    auto refreshToken =
...
void TwitchAccountData::save() const
{
    ...
    pajlada::Settings::Setting<std::underlying_type_t<TwitchAccount::Type>>::
        set(basePath + "/accountType",
            static_cast<std::underlying_type_t<TwitchAccount::Type>>(this->ty));
